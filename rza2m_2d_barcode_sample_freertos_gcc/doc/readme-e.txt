...
/*******************************************************************************
*
* History     : Jun. 30,2020 Rev.1.00.00    First edition issued
*             : Sep. 30,2020 Rev.1.01.00    Updated to e2 studio 2020-07
*             : Apr. 20,2021 Rev.1.02.00    Updated to e2 studio 2021-04
*******************************************************************************/
...
3. About Sample Code
    ...
    This sample program uses a Dynamic Reconfigurable Processor (DRP) to decode 2D barcodes.
    The open source project ZXing (short for Zebra Crossing) is used in this program as an algorithm for decoding 
    2D barcodes.
